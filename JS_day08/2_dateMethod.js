...
//getTime 메소드 : 1970년 1월 1일 기준으로 지나온 시간을 ms 단위로 계산하여 리턴 - 타임스탬프(timestamp)
...
console.log(year.toString() + month.toString().padStart(2,0) + date_.toString())
...
// console.log(diff/oneday_timestamp)
